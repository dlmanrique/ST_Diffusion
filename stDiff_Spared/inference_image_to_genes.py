...
def main():
    ...
    if args.debbug_wandb:
        ...
        wandb.init(project="debbugs_v2", entity="spared_v2", name=exp_name + '_inference_debbug')

    else:
        exp_name = datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
        wandb.init(project="Image_to_Genes", entity="spared_v2", name=exp_name + '_inference' )
    ...
    model.to(device)
    model_path = 'Experiments/2025-01-23-18-56-27/post_test.pth'
