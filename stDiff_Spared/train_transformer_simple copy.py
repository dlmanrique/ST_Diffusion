...
if not os.path.exists(os.path.join("/home/dvegaa/ST_Diffusion/stDiff_Spared/autoencoder_replicate", f"{args.dataset}")):
    os.makedirs(os.path.join("/home/dvegaa/ST_Diffusion/stDiff_Spared/autoencoder_replicate", f"{args.dataset}"))

trainer.save_checkpoint(os.path.join("/home/dvegaa/ST_Diffusion/stDiff_Spared/autoencoder_replicate", f"{args.dataset}", "autoencoder_model.ckpt"))
...
checkpoint_path = os.path.join("/home/dvegaa/ST_Diffusion/stDiff_Spared/autoencoder_replicate", f"{args.dataset}", "autoencoder_model.ckpt")
